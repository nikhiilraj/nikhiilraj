<div align="center">
  <img src="./GitHub Banner Preview.svg" alt="Nikhil Raj" width="100%"/>
</div>
...
that gap — where the obvious solution lives but nobody takes it seriously — is where i spend most of my time.

i work in **TypeScript** and **Node.js** by default.  
i reach for **Python** when the problem demands it.  
i think in **systems**, write in **constraints**, and ship in **silence**.

currently somewhere between backend architecture and AI-native infrastructure —  
not the chatbot kind. the *what happens when the model needs to reason across state* kind.
